    ...
    "entries": [
      {
        ...
        "fields": [
          {
            "label": "Effet",
            "text": "Quantité ↑ · PRU recalculé · solde espèces ↓ de (quantité × prix + frais + taxe) · aucun P/L réalisé · une opération par exécution si l'ordre est dénoué partiellement"
          },
          {
            "label": "Exemple",
        ...
        "blocks": [
          ...
          {
            "kind": "sub",
            "text": "Exécution partielle d'un ordre au marché (MKT) — plusieurs opérations"
          },
          {
            "kind": "text",
            "text": "Un ordre au marché ne fixe pas de prix : il se dénoue au fil du carnet, parfois en plusieurs exécutions à des prix distincts le même jour si la quantité disponible à la meilleure limite ne suffit pas. Chaque exécution est un fait daté à part entière et produit donc sa propre opération BUY, toutes rattachées à la même transaction — même principe qu'un ordre à cours limité dénoué sur plusieurs jours."
          },
          {
            "kind": "code",
            "text": "{\n  \"id\": 26,\n  \"date\": \"2026-03-11\",\n  \"comment\": \"Ordre au marché, exécuté en trois fois\",\n  \"operations\": [\n    {\n      \"id\": 37,\n      \"sequence\": 1,                   // premiere execution : meilleure limite\n      \"date\": \"2026-03-11\",\n      \"type\": \"BUY\",\n      \"platform\": 3,\n      \"isin\": \"FR0000120073\",          // Air Liquide\n      \"quantity\": 10,\n      \"price\": 168.50,\n      \"fee\": 1.25,                     // frais de l ordre repartis au prorata\n      \"tax\": 0                         // de la quantite de chaque execution\n    },\n    {\n      \"id\": 38,\n      \"sequence\": 2,                   // deuxieme execution : la liquidite\n      \"date\": \"2026-03-11\",            // s epuise, le prix monte legerement\n      \"type\": \"BUY\",\n      \"platform\": 3,\n      \"isin\": \"FR0000120073\",\n      \"quantity\": 6,\n      \"price\": 168.55,\n      \"fee\": 0.75,\n      \"tax\": 0\n    },\n    {\n      \"id\": 39,\n      \"sequence\": 3,                   // troisieme et derniere execution\n      \"date\": \"2026-03-11\",\n      \"type\": \"BUY\",\n      \"platform\": 3,\n      \"isin\": \"FR0000120073\",\n      \"quantity\": 4,\n      \"price\": 168.62,\n      \"fee\": 0.50,\n      \"tax\": 0\n    }\n  ]\n}\n\n// Effet : quantité + 20 (10 + 6 + 4), coût de revient de la ligne\n//         + 3 373,28 EUR, PRU recalculé en moyenne pondérée à 168,66 EUR.\n//         Solde espèces : -3 373,28 EUR.\n//\n// Trois operations pour un seul ordre, chacune datee et prixee separement.\n// Les frais de courtage de l ordre, saisis une seule fois (2,50 EUR, comme\n// dans l exemple a execution unique ci-dessus), sont repartis au prorata\n// de la quantite de chaque execution : 1,25 + 0,75 + 0,50 = 2,50 EUR.\n// Le PRU final (168,66 EUR) differe legerement de celui d une execution\n// unique au meme prix moyen — c est le cout reel d un ordre qui a du\n// remonter le carnet pour se remplir."
          }
        ]
      },
      {
